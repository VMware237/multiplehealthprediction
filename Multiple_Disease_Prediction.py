...
diabetes_model = pickle.load(open(f'{working_dir}/saved models/Disease_Prediction_Diabetes.sav', 'rb'))
diabetes_scaler = pickle.load(open(f'{working_dir}/saved models/scaler.sav', 'rb'))

heart_model = pickle.load(open(f'{working_dir}/saved models/Heart_Disease_Prediction.sav', 'rb'))
heart_scaler = pickle.load(open(f'{working_dir}/saved models/scaler_heart.sav', 'rb'))

parkinsons_model = pickle.load(open(f'{working_dir}/saved models/Parkinsons_Prediction.sav', 'rb'))
parkinsons_scaler = pickle.load(open(f'{working_dir}/saved models/scaler_parkinsons.sav', 'rb'))
